...
df = pd.read_csv(r'c:\Users\Gamer\OneDrive\Documentos\EBAC\CURSO ANALISTA DE DADOS\PYTHON\7-Python Visualização de Dados Avançada\PROVA\ecommerce_estatistica.csv')
